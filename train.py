...
if __name__=='__main__':
    ...
    if params.method in ['baseline', 'baseline++'] :
    ...
    elif params.method in ['protonet','protonetn','matchingnet','relationnet', 'relationnet_softmax', 'maml', 'maml_approx']:
        ...
        if params.method == 'protonet':
            ...
            assert params.n_shot >= 2, 'protonetn does not support 1 shot, use 2 or more shot'
            model = ProtoNetN(model_dict[params.model], **train_few_shot_params)
